...
await writeFile(
  ...
  [
    ...
    'if (!result.code.includes("catalog.messages.gen.mjs")) throw new Error("Pack smoke did not use the single private message module");',
    ...
    'await writeFile("smoke.mjs", result.code, "utf8");',
    "",
  ].join("\n"),
  "utf8"
);
